...
export type Asset={id:string;name:string;category:string;tags:string[];paths:Paths;preview:string;license:string;revision:number;viewBox:number[];description?:string;minFeature?:number;group?:'simple'|'dense';coverage?:number;repeatStep?:number};
